                ...
                <?php include '../includes/topnav.php'; ?>
                    ...
                    <div id="content">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <form action="../../ajaxadmin/ajaxadmin.php?insertNewDepartment" method="POST" class="col-lg-5  p-0">
                                    <div class="card">
                                        ...
                                        <form>
                                            ...
                                            <input type="text" required class="form-control form-control-lg" name="d_id" id="d_id">
                                            </div>
                                            <div class="form-group">
                                            <label for="d_name" class="col-form-label-lg">Department Name</label>
                                            <input type="text" required class="form-control form-control-lg" name="d_name" id="d_name">
                                            </div>
