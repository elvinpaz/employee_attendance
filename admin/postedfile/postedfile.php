                ...
                <?php include '../includes/topnav.php'; ?>
                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <h1 class="h3 mb-4 text-gray-800">Posted Files</h1>
                            <p style="margin-top: -25px;">Every file you post here will see by other employees.</p>

                            <div class="row justify-content-center mt-5">
                                <div class="col-4">
                                    <div class="card">
                                        <div class="card-body" style="height:550px;">
                                            <form action="../../ajaxadmin/ajaxadmin.php?insertNewPostedFile" method="POST" enctype="multipart/form-data">
                                                <p style="text-align: center; font-size:20px;" class="mb-4">Share Files</p>
                                                <p>Description:</p>
                                ...
                                <div class="col-6">
                                    <div class="card">
                                        ...
                                        <p style="text-align: center; font-size:20px;" class="mb-4">Files you've been posted</p>
                                        ...
                                        ?>
                                            ...
                                            <div class="callout callout-success">
                                                <div class="row filedisplay" style="border-radius: 5px; height:100%; width: 100%; margin-left:0px">
                                                    ...
                                                    <div class="col-1">
                                                        <a href="../../ajaxadmin/ajaxadmin.php?deleteposted&date=<?=$row['date']?>" title="Delete" onclick="return confirm('Deleted Files. Still want to delete?')">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body" style="height:600px; overflow-y: scroll">
                                            <div class="row justify-content-center mt-2">
                                                ...
                                                <?php
                                                    $x = 1;
                                                    $query = "SELECT * FROM fileupload WHERE status = 1 AND employee_id = '".$_SESSION['emp_id']."' ORDER BY id DESC";
                                                    $result = mysqli_query($connection, $query);
                                                    if (mysqli_num_rows($result) > 0) {
                                                        while ($row = mysqli_fetch_assoc($result)) {
                                                ?>
