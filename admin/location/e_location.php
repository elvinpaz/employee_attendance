                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <h1 class="h3 mb-4 text-gray-800"></h1>
                                ...
                                <form action="../../ajaxadmin/ajaxadmin.php?submitEditLocation" method="POST" class="col-lg-5  p-0">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <input type="text" readonly class="form-control-plaintext form-control-lg" name="id" value="<?= $id;?>">
                                            </div>
                                            <div class="form-group">
